...
class Pawn(Piece):
    def __init__(self, pos, color, board):
        ...
        img_path = 'assets/pieces/' + color[0] + '_pawn.png'
        self.img = pygame.image.load(img_path)
        self.img = pygame.transform.scale(self.img, (board.tile_width - 40, board.tile_height - 35))
        self.notation = ' '
    ...
    def attacking_squares(self, board):
        ...
        # Retorna os movimentos na diagonal
